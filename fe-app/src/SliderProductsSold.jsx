      ...
      <div className="slide-container-products">
        <Slide showNavs="false">
          <div className="each-slide-products">
           <p><img className="" src={topRankingIcon}/>Best Sellers from Cellphones And Telecommunications</p>
          ...
          <div className="each-slide-products">
           <p><img className="" src={topRankingIcon}/>Best Sellers from Office And Computers</p>
          <div className="topRanking">
